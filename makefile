...
OBJECTS = $(OBJDIR)/edge.o $(OBJDIR)/kruskal.o $(OBJDIR)/quick-union.o $(OBJDIR)/vector.o $(OBJDIR)/vertex.o $(OBJDIR)/graph.o $(OBJDIR)/stack.o $(OBJDIR)/reading.o $(OBJDIR)/dfs.o $(OBJDIR)/quick-union-baludo.o
...
$(OBJDIR)/quick-union-baludo.o: $(SRCDIR)/quick-union-baludo.c
	$(CC) $(CFLAGS) -c $(SRCDIR)/quick-union-baludo.c -o $(OBJDIR)/quick-union-baludo.o
